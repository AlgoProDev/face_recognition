...
def analysis(
    ...
    FaceComparer.build_model(model_name=model_name)
    ...
    while True:
        ...
        if freeze == False:
            try:
                ...
                face_objs = FaceComparer.extract_faces(
                    img_path=img,
                    ...
                    for detected_face in detected_faces_final:
                        ...
                        if len(dfs) > 0:
                            ...
                            if df.shape[0] > 0:
                                ...
                                source_objs = FaceComparer.extract_faces(
                                    img_path=label,
